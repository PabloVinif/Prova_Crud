...
public class TrabalhoService {
    ...
    public TrabalhoDto save(TrabalhoDto trabalhoDto) {
        ...
        return new TrabalhoDto(savedtrabalho.getId(), savedtrabalho.getNome(), savedtrabalho.getEndereco());
    }
    ...
    public TrabalhoDto update(Long id, TrabalhoDto trabalhoDto) {
        ...
        trabalhoExistente.setEndereco(trabalhoDto.getEndereco());

        Trabalho updatedtrabalho = trabalhoInterface.save(trabalhoExistente);
        return new TrabalhoDto(updatedtrabalho.getId(), updatedtrabalho.getNome(), updatedtrabalho.getEndereco());
    }
